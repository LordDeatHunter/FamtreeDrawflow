...
export default class Drawflow {
  constructor(container: HTMLElement, render?: object, parent?: object);
  /**
   * Selected element
   * @default null
   */
  ...
  /**
   * Functions to call on different click events
   */
...
export type ClickActions = Record<
  string,
...
export type CurvatureType = "open" | "close" | "other";
